        ...
        <div className="relative z-10 flex items-center justify-center px-6 py-16">
          ...
          >
            <div className="mb-8 text-center">
              <p className="text-xs uppercase tracking-[0.4em] text-indigo-400">Create Student Account</p>
              <h1 className="mt-3 text-3xl font-semibold">Join your class and start your personalized learning journey</h1>
              <p className={`mt-2 text-sm ${mutedText}`}>
                Access adapted assignments, reminders, and live feedback in one private hub.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div>
                  <label className={`text-xs font-semibold uppercase tracking-[0.3em] ${mutedText}`}>Date of Birth</label>
                  <input
                    type="date"
                    value={dateOfBirth}
              ...
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <span className={`text-xs ${mutedText}`}>Optional</span>
                </div>
                <div className="mt-1 flex gap-2">
                  ...
                  <button
                    type="button"
                    className="rounded-xl border border-slate-200 px-4 text-sm font-semibold text-slate-600 transition hover:border-indigo-500 hover:text-indigo-500 dark:border-white/20 dark:text-white"
                  >
                    Verify
                  </button>
                </div>
                <p className={`mt-2 text-xs ${mutedText}`}>
                  If you have a class code from your teacher, enter it here. You can also join a class later.
                </p>
              </div>
            ...
            <div className="mt-6 space-y-2 text-center text-sm">
              <p className={mutedText}>
                ...
                <Link href="/student/login" className={`font-medium ${accentLink}`}>
                  Sign in
                </Link>
              </p>
              <p className={mutedText}>
                Are you a teacher?{" "}
                <Link href="/teacher/signup" className={`font-medium ${accentLink}`}>
