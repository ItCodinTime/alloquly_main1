        ...
        <div className="relative z-10 flex items-center justify-center px-6 py-16">
          <div className={`w-full max-w-md rounded-2xl border p-8 shadow-2xl backdrop-blur ${cardClass}`}>
            ...
            <div className={`mb-6 flex gap-2 rounded-full border p-1 text-sm ${toggleWrapper}`}>
              {["student", "teacher"].map((roleOption) => (
                <button
                  key={roleOption}
                  type="button"
                  onClick={() => setSelectedRole(roleOption as "student" | "teacher")}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="student-email" className={`block text-sm font-medium ${labelClass}`}>
                  Email
                </label>
                <input
                  id="student-email"
              ...
              <div>
                <label htmlFor="student-password" className={`block text-sm font-medium ${labelClass}`}>
                  Password
                </label>
                <input
                  id="student-password"
